...
import {ejercicio23, ejercicio24} from "./ejercicio2.js";
...
console.log("2. Segundo ejercicio");
    ...
    console.log("Media de calorías: " + ejercicio23(result));
    console.log()


    //Mostrar la suma de las grasas saturadas de todos los donuts
    console.log("Suma de las grasas saturadas de todos los donuts: "  + ejercicio24(result));
    console.log()



    ////////// a partir de aquí, no está distribuído entre los ficheros//////////////
